...
describe('exists', async () => {
  ...
  //
  // BleachPoemsSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof BleachPoemsSDK, true,
      'BleachPoemsSDK.test() must return a client synchronously')
  })
