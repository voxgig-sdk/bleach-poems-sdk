...
{
    private static function utility(): BleachPoemsUtility
    {
        return new BleachPoemsUtility();
    }
    ...
    private static function ctx(array $over = []): BleachPoemsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BleachPoemsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BleachPoemsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BleachPoemsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BleachPoemsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BleachPoemsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BleachPoemsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BleachPoemsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BleachPoemsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BleachPoemsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BleachPoemsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BleachPoemsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BleachPoemsResponse([]),
            'result' => new BleachPoemsResult([]),
        ]);
        [, $err] = BleachPoemsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec([]),
            'response' => null,
            'result' => new BleachPoemsResult([]),
        ]);
        [, $err] = BleachPoemsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec(['step' => 's']),
            'response' => new BleachPoemsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BleachPoemsResult([]),
        ]);
        [, $err] = BleachPoemsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec(['step' => 's']),
            'response' => new BleachPoemsResponse(self::resp(200, ['v' => 1])),
            'result' => new BleachPoemsResult([]),
        ]);
        [, $err] = BleachPoemsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec(['step' => 's']),
            'response' => new BleachPoemsResponse(self::resp(200, ['v' => 2])),
            'result' => new BleachPoemsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BleachPoemsMakeResponse::call($ctx);
    ...
    {
        $preset = new BleachPoemsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec([]),
            'response' => new BleachPoemsResponse([]),
            'result' => new BleachPoemsResult([]),
        ...
        [$got, $err] = BleachPoemsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BleachPoemsResult([])]);
        [, $err] = BleachPoemsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BleachPoemsSpec([]), 'result' => null]);
        [, $err] = BleachPoemsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BleachPoemsSpec(['step' => 's']),
            'result' => new BleachPoemsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BleachPoemsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BleachPoemsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BleachPoemsSpec(['step' => 's']),
            'result' => new BleachPoemsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BleachPoemsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BleachPoemsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BleachPoemsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BleachPoemsSpec([]),
            'result' => new BleachPoemsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BleachPoemsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BleachPoemsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BleachPoemsError('boom', 'boom');
        $utility->fetcher = function (BleachPoemsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BleachPoemsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BleachPoemsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BleachPoemsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BleachPoemsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BleachPoemsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BleachPoemsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BleachPoemsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BleachPoemsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BleachPoemsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BleachPoemsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BleachPoemsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BleachPoemsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BleachPoemsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BleachPoemsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BleachPoemsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BleachPoemsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BleachPoemsResult(['ok' => false])]);
        $this->expectException(BleachPoemsError::class);
        BleachPoemsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BleachPoemsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BleachPoemsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BleachPoemsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BleachPoemsBaseFeature();
        $b = new BleachPoemsBaseFeature();
        BleachPoemsFeatureAdd::call($ctx, $a);
        BleachPoemsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BleachPoemsBaseFeature
    {
        $f = new BleachPoemsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BleachPoemsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BleachPoemsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BleachPoemsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BleachPoemsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BleachPoemsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BleachPoemsResponse(['headers' => null]),
            'result' => new BleachPoemsResult([]),
        ]);
        BleachPoemsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BleachPoemsResultBody::call($ctx);
