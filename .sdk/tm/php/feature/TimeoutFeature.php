...
// BleachPoems SDK timeout feature
...
class BleachPoemsTimeoutFeature extends BleachPoemsBaseFeature
{
    ...
    private function _with_timeout(BleachPoemsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BleachPoemsContext $_ctx, float $ms): void
    {
        $client = $this->client;
