...
class BleachPoemsProxyFeature extends BleachPoemsBaseFeature
{
    ...
    public function init(BleachPoemsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BleachPoemsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
