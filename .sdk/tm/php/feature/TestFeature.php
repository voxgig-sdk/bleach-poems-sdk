...
// BleachPoems SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BleachPoemsTestFeature extends BleachPoemsBaseFeature
{
    ...
    public function init(BleachPoemsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BleachPoemsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BleachPoemsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BleachPoemsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BleachPoemsContext $ctx, $op, $args): array
    {
