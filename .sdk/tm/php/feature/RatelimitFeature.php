...
// BleachPoems SDK ratelimit feature
...
class BleachPoemsRatelimitFeature extends BleachPoemsBaseFeature
{
    ...
    private function _acquire(BleachPoemsContext $ctx): void
    {
    ...
    private function _track(BleachPoemsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
