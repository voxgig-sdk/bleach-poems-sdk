...
class BleachPoemsRbacFeature extends BleachPoemsBaseFeature
{
    ...
    private function _required(BleachPoemsContext $ctx): ?string
    {
    ...
    private function _reject(BleachPoemsContext $ctx, string $required): void
    {
    ...
    private function _track(BleachPoemsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
