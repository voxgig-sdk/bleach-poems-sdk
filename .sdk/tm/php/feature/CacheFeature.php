...
class BleachPoemsCacheFeature extends BleachPoemsBaseFeature
{
    ...
    private function _through(BleachPoemsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
