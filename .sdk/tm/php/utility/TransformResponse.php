...
// BleachPoems SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BleachPoemsTransformResponse
{
    public static function call(BleachPoemsContext $ctx): mixed
    {
        ...
        $transform = BleachPoemsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
