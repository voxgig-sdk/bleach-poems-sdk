...
// BleachPoems SDK utility: graphql
//
...
class BleachPoemsGraphql
{
    ...
    // equivalent.
    public static function body(BleachPoemsContext $ctx): mixed
    {
    ...
    public static function errors(BleachPoemsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
