...
function runner.env_override(m)
  local live = runner.getenv("BLEACH_POEMS_TEST_LIVE")
  local override = runner.getenv("BLEACH_POEMS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLEACH_POEMS_TEST_EXPLAIN")
