...
function runner.env_override(m)
  local live = runner.getenv("BLEACHPOEMS_TEST_LIVE")
  local override = runner.getenv("BLEACHPOEMS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLEACHPOEMS_TEST_EXPLAIN")
