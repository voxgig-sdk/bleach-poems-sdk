// Command BleachPoems-cli is a CLI + REPL for the BleachPoems SDK,
...
const prompt = "bleach-poems"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "poem"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BLEACH_POEMS_APIKEY (api key), BLEACH_POEMS_BASE (base url override)")
