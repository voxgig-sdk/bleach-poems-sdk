...
func registerSDKWords(r *eng.Registry, client *sdk.BleachPoemsSDK) {
...
func runOp(client *sdk.BleachPoemsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
