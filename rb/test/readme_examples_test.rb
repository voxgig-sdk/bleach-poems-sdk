...
#      offline in seeded test mode (BleachPoemsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BleachPoems_sdk.rb")
  SDK_CLASS = "BleachPoemsSDK"
