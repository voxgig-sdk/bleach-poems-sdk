...
// BleachPoems SDK clienttrack feature
...
class BleachPoemsClienttrackFeature extends BleachPoemsBaseFeature
{
    ...
    public function PostConstruct(BleachPoemsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BleachPoems-SDK';
