...
// BleachPoems SDK netsim feature
...
class BleachPoemsNetsimFeature extends BleachPoemsBaseFeature
{
    ...
    private function _simulate(BleachPoemsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BleachPoemsContext $ctx, array $applied): void
    {
        $client = $this->client;
