...
// BleachPoems SDK metrics feature
...
class BleachPoemsMetricsFeature extends BleachPoemsBaseFeature
{
    ...
    private function _record(BleachPoemsContext $ctx, bool $ok): void
    {
