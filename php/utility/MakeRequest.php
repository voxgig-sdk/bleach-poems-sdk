...
// BleachPoems SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BleachPoemsMakeRequest
{
    public static function call(BleachPoemsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BleachPoemsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BleachPoemsResponse($fetched);
        } else {
