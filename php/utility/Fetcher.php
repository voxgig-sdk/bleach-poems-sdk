...
// BleachPoems SDK utility: fetcher

class BleachPoemsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BleachPoemsSDK/1.0)';
    ...
    public static function call(BleachPoemsContext $ctx, string $fullurl, array $fetchdef): array
    {
