...
class BleachPoemsSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = BleachPoemsHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = BleachPoemsHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!BleachPoemsFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, BleachPoemsFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return BleachPoemsUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = BleachPoemsHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = BleachPoemsHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = BleachPoemsHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new BleachPoemsError($op . "_allow",
                "BleachPoemsSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = BleachPoemsHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new BleachPoemsError("graphql_error",
                "BleachPoemsSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Poem($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_poem === null) {
                $this->_poem = new PoemEntity($this, null);
            }
            return $this->_poem;
        }
        return new PoemEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new BleachPoemsSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
