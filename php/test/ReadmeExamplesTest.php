...
// BleachPoems SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BleachPoemsSDK::test)
...
{
    private const SDK_CLASS = 'BleachPoemsSDK';
    ...
    private const SDK_BASE = 'bleachpoems_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bleachpoems_sdk.php';
