...
class FtCtrl extends BleachPoemsControl
{
...
class FtClient
{
    ...
    private BleachPoemsUtility $utility;

    public function __construct(BleachPoemsUtility $utility, array $options)
    {
    ...
    public function get_utility(): BleachPoemsUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BleachPoemsContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BleachPoemsContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BleachPoemsContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BleachPoemsConfig::make_feature($name);
    ...
    private static function buildUrl(BleachPoemsSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BleachPoemsError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BleachPoemsResponse($fetched);
        }
    ...
    private function fail(BleachPoemsContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BleachPoemsContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
