...
type PoemEntity struct {
	name    string
	client  *core.BleachPoemsSDK
...
func NewPoemEntity(client *core.BleachPoemsSDK, entopts map[string]any) *PoemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PoemEntity) GetName() string { return e.name }
...
func (e *PoemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PoemEntity) Deleted() bool {
	return e.deleted
}


func (e *PoemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPoemEntity(e.client, opts)
}

func (e *PoemEntity) Data(args ...any) any {
...
func (e *PoemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Poem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PoemEntity) DataTyped(data ...Poem) Poem {
	if len(data) > 0 {
		return typedFrom[Poem](e.Data(asMap(data[0])))
	}
	return typedFrom[Poem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Poem (all fields
// optional at the wire level).
func (e *PoemEntity) MatchTyped(match ...Poem) Poem {
	if len(match) > 0 {
		return typedFrom[Poem](e.Match(asMap(match[0])))
	}
	return typedFrom[Poem](e.Match())
}
...
func (e *PoemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PoemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PoemLoadMatch and returns an Poem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PoemEntity) LoadTyped(reqmatch PoemLoadMatch, ctrl map[string]any) (Poem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Poem{}, err
	}
	return typedFrom[Poem](res), nil
}




func (e *PoemEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PoemListMatch and returns []Poem. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PoemEntity) ListTyped(reqmatch PoemListMatch, ctrl map[string]any) ([]Poem, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Poem](res), nil
}



func (e *PoemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PoemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PoemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PoemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
