// Command BleachPoems-mcp is an MCP server exposing the BleachPoems
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BleachPoems_list  — list records of an entity
//	BleachPoems_load  — load a single record of an entity
//
