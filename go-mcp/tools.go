...
type Args struct {
	Entity string         `json:"entity" jsonschema:"poem"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BleachPoemsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bleach-poems_list",
		Description: "List records from BleachPoems. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bleach-poems_load",
		Description: "Load a single record from BleachPoems. " +
...
func runOp(client *sdk.BleachPoemsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BleachPoemsSDK, name string) (sdk.BleachPoemsEntity, error) {
	switch strings.ToLower(name) {
	case "poem":
		return client.Poem(nil), nil
