...
from bleachpoems_sdk.core.helpers import get_ctx_prop, to_map
...
class BleachPoemsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BleachPoemsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BleachPoemsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BleachPoemsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BleachPoemsError(code, msg, self)
