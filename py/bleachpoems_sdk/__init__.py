...
from bleachpoems_sdk.utility import register

# Load features
from bleachpoems_sdk.feature.base_feature import BleachPoemsBaseFeature
from bleachpoems_sdk.features import _has_feature, _make_feature
...
class BleachPoemsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BleachPoemsUtility()
        self._utility = utility

        from bleachpoems_sdk.config import shared_config
    ...
    def get_utility(self):
        return BleachPoemsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BleachPoemsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Poem(self, data=None) -> "PoemEntity":
        ...
        from bleachpoems_sdk.entity.poem_entity import PoemEntity
