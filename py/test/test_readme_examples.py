# BleachPoems SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BleachPoemsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BleachPoemsSDK(...) and BleachPoemsSDK.test(...) become
#      BleachPoemsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bleachpoems_sdk"
_SDK_CLASS = "BleachPoemsSDK"
