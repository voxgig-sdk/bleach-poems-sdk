...
class BleachPoemsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BleachPoemsTestRunner.getenv("BLEACHPOEMS_TEST_LIVE")
        override = BleachPoemsTestRunner.getenv("BLEACHPOEMS_TEST_OVERRIDE")
        ...
        explain = BleachPoemsTestRunner.getenv("BLEACHPOEMS_TEST_EXPLAIN")
